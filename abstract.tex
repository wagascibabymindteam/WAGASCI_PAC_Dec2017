\begin{abstract}
 We, the WAGASCI collaboration, proposes to perform the study of the neutrino-nucleus interaction at the B2 floor of the neutrino monitor building with a new-type fine-grained neutrino detector and muon range detectors.
 ...
 on $\mathrm{H_2O}$.
Measurement in wide phase space becomes possible by the combination of the WAGASCI modules and side- and downstream- muon range detectors (MRD's).
...
We will provide the inclusive and exclusive differential cross sections of the charged current neutrino and antineutrino interactions on water and hydrocarbon
with slightly higher neutrino energy than T2K ND280 with wider angler acceptance.
