...
\subsubsection{Performance check}
...
% An event display from the summer 2017 tests is shown in Figure~\ref{beam_vs_cosmic}.
...
\insertgraph{1.0}{baby_mind_muon_tracks.pdf}{Y-Z hit profiles in Baby MIND detector modules for positive (upper row) and negative (lower row) muon beam settings during the summer 2017 beam tests at the CERN-PS facility. Muon momentum settings for the beam shown here are 2 GeV/c, 1.5 GeV/c and 0.5 GeV/c for left, middle and right plots respectively.}{baby_mind_muon_track}
