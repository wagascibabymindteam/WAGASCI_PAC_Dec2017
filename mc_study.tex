...
Figure \ref{fig:endpoint_smrd_longest_track_neutrino} and \ref{fig:endpoint_babymind_longest_track_neutrino} show the iron plane numbers in Side-MRD and Baby-MIND corresponding to the end points of the longest tracks in the selected events in the neutrino-mode.
...
\label{fig:fig:endpoint_smrd_longest_track_neutrino}
\end{figure}
...
Figure \ref{fig:endpoint_smrd_longest_track_antineutrino} and \ref{fig:endpoint_babymind_longest_track_antineutrino} show the iron plane numbers in Side-MRD and Baby-MIND corresponding to the end points of the longest tracks in the selected events in the antineutrino-mode.
